...
export function AboutSection({ skills }: { skills: SkillItem[] }) {
  return (
    <Section id="about">
      <SectionHeading
        eyebrow="About"
        title="Delivery-focused developer with a strong data background"
        description="I combine pragmatic engineering with clear communication and a bias toward shipping."
      />
