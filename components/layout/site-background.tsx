...
/**
 * Decorative, ultra-light background treatment.
 *
 * Tailwind v4 note:
 * - Uses utility-driven gradients + arbitrary values (v4-friendly).
 * - No bespoke CSS required.
 */
export function SiteBackground({
  ...
  return (
    <div className={cn("relative isolate", className)}>
      {/* Soft grid + glow. Kept subtle to avoid distracting from content. */}
      <div
        aria-hidden="true"
      ...
      >
        ...
        {/* Two-layer, color-tinted glow (kept subtle; uses theme OKLCH tokens). */}
        ...
        {/* Secondary orb: positioned lower to create depth and balance. */}
