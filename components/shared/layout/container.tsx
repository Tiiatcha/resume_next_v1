...
function Container({
  ...
  const variants: Record<ContainerVariant, string> = {
    default: cn(baseClasses, "container flex flex-col items-center justify-center"),
...
function ContainerIntro({
  ...
  const variants: Record<ContainerVariant, string> = {
    default: "container-intro text-center flex flex-col items-center justify-center gap-4",
